 ...
 */
public class Day_5_Normal_Distribution_I {
    ...
    public static void main(String[] args) {
        ...
        double lessThan = scan.nextDouble();
        double between1 = scan.nextDouble();
        double between2 = scan.nextDouble();
        System.out.println(String.format("%.3f", P(lessThan, mean, standardDeviation)));
        System.out.println(String.format("%.3f", P(between2, mean, standardDeviation) - P(between1, mean, standardDeviation)));
        scan.close();
    }
}
